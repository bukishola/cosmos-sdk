...
type InflationCalculationFn func(ctx sdk.Context, minter Minter, params Params, bondedRatio sdk.Dec, circulatingRatio sdk.Dec) sdk.Dec

// DefaultInflationCalculationFn is the default function used to calculate inflation.
func DefaultInflationCalculationFn(_ sdk.Context, minter Minter, params Params, bondedRatio sdk.Dec, circulatingRatio sdk.Dec) sdk.Dec {
	return minter.NextInflationRate(params, bondedRatio, circulatingRatio)
}
